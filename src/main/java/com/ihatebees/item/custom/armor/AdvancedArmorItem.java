...
public class AdvancedArmorItem extends ArmorItem implements GeoItem {
    ...
    public AdvancedArmorItem(ArmorMaterial armorMaterial, Type type, Settings properties) {
        ...
        if (this.getSlotType() == EquipmentSlot.HEAD) {
            ...
            builder.put(EntityAttributes.GENERIC_LUCK, new EntityAttributeModifier(UUID.randomUUID(), "Luck", .2, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            ...
            builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(UUID.randomUUID(), "Attack Damage", .1, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
        } else if (this.getSlotType()==EquipmentSlot.FEET)  {
            builder.put(EntityAttributes.GENERIC_ARMOR, new EntityAttributeModifier(UUID.randomUUID(), "Armor", 3, EntityAttributeModifier.Operation.ADDITION));
            builder.put(EntityAttributes.GENERIC_LUCK, new EntityAttributeModifier(UUID.randomUUID(), "Luck", .2, EntityAttributeModifier.Operation.MULTIPLY_BASE));
            builder.put(EntityAttributes.GENERIC_MOVEMENT_SPEED, new EntityAttributeModifier(UUID.randomUUID(), "Movement Speed", .15, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
        }
